...
cp "$REPO_DIR/lib/launch.sh" "$REPO_DIR/lib/import-roms.sh" "$REPO_DIR/lib/fetch-and-play.sh" "$REPO_DIR/lib/make-open-source-catalog.sh" "$REPO_DIR/lib/make-settings-catalog.sh" "$M/lib/"
...
cp "$REPO_DIR/lib/launch.sh" "$REPO_DIR/lib/import-roms.sh" "$REPO_DIR/lib/fetch-and-play.sh" "$REPO_DIR/lib/make-open-source-catalog.sh" "$REPO_DIR/lib/make-settings-catalog.sh" "$L/lib/"
